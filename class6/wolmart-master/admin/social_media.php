            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title text-capitalize text-success">Social Media</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        <?php
                        ...
                        <form action="Social_post.php" method="post">
                              <div class="mb-3">
                              <label class="form-lable text-capitalize">Social link</label>
                                  <input type="text" name="social_link" class="form-control">
                              </div>
                              <div class="mb-3">
                              <label class="form-lable text-capitalize">Social Icon</label>
                                  <input type="text" name="social_icon" id="social_input" class="form-control">
                              </div>
                            <div class="mb-3 overflow-scroll"        style="height: 200px;">
                              <?php
                              $iconsFA = array("fa-500px","fa-address-book","fa-address-book-o","fa-address-card","fa-address-card-o","fa-adjust","fa-adn","fa-align-center","fa-align-justify","fa-align-left","fa-align-right",
                              ...
                              <?php foreach ($iconsFA as $key => $value):
                                ?>
                                <span id="<?=$value?>" class="btn btn-dark m-2">
                              ...
                              ?> 
                                   ...
                                   <button class="btn btn-success text-uppercase">Add Social</button>
                              </div>
                        </form>
                    </div>
                </div>
                            ...
                            <tbody>
                                 ...
                                 ?> 
                                     <tr>
                                         ...
                                         <td><?=$banner['social_link']?></td>
                                         <td><i class="fa <?=$banner['social_icon']?>"></i></td>
                                         <td><a href="Social_edit.php?header_edit_id=<?=$banner['id']?>" class="btn btn-info">edit</a>
                                           </td>
                                           <td>
                                           <?php
