                    ...
                    <div class="card-body">
                        <form action="service_item_edit_post.php" method="post" enctype="multipart/form-data">
                            ...
                            <?php
                                ...
                                ?>
                                <label class="form-lable text-capitalize">Service item header</label>
                                <input type="text" name="ser_item_h2" class="form-control" value="<?=$afterassocc['ser_item_h2']?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="ser_item_text" class="form-control" value="<?=$afterassocc['ser_item_text']?>">
                            </div>
                            <div class="mb-3">
                           
                                <label class="form-lable text-capitalize">Service Image</label>
                            ...
                            <div class="mb-3">
                                <button type="submit" class="form-control btn btn-primary">Add Service Item</button>
                            </div>
                        </form>
                    </div>
                </div>
